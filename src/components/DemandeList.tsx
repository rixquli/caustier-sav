...
import type { DemandeCardListProps } from "@/types/demande";
      ...
      {demandes.map((demande) => {
        ...
        return (
          <li key={demande.id} className="demande-card-item">
            <Link
              href={`${detailBasePath}/${demande.id}`}
              className="demande-card-link"
            >
              <div className="demande-card-main">
                ...
                <p>
                  ...
                  {demande.machine_nom || "Machine non renseignée"} · Dernière
                  activité{" "}
