...
export default function ClientDashboard({ user }: ClientDashboardProps) {
  const [actives, setActives] = useState<DemandeDisplay[]>([]);
  const [history, setHistory] = useState<DemandeDisplay[]>([]);

  useEffect(() => {
    fetch("/api/dashboard")
      .then((res) => (res.ok ? res.json() : null))
      .then(
        (data: { actives?: DemandeDisplay[]; history?: DemandeDisplay[] } | null) => {
  ...
  return (
    <div className="dashboard">
      <div className="dashboard-header">
        ...
        <Link href="/demandes?nouvelle=1" className="dashboard-primary-cta">
      ...
      <div className="dashboard-grid">
        ...
        <section className="dashboard-panel">
          ...
          <div className="quick-actions">
            <Link href="/demandes?nouvelle=1" className="quick-action quick-action--primary">
